...
return [
            ...
            'products' => [
                ...
                'imports' => [
                    ...
                    'messages' => [
                        ...
                        'category_forbidden' => 'Категорія не дозволена для поточної ролі.',
                    ],
                    'table' => [
    ...
    'conversation' => [
        ...
        'message' => 'Повідомлення',
        'indicators' => [
            'awaiting_customer' => 'Очікує на клієнта',
            'read' => 'Прочитано :time',
        ],
    ],
    ...
    'api' => [
        ...
        'orders' => [
            ...
            'sold_out' => 'Товар закінчився на всіх складах. Просимо вибачення за незручності.',
