const messages = {
    ...
    wishlist: {
        ...
        errors: {
            auth: 'Войдите, чтобы синхронизировать избранное.',
            sync: 'Не удалось синхронизировать список желаний.',
            partialSync: 'Некоторые товары не удалось синхронизировать со списком желаний.',
        },
        empty: 'Пока пусто.',
        button: {
