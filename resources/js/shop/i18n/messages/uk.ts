const messages = {
    ...
    wishlist: {
        ...
        errors: {
            auth: 'Увійдіть, щоб синхронізувати обране.',
            sync: 'Не вдалося синхронізувати список бажаного.',
            partialSync: 'Деякі товари не вдалося синхронізувати зі списком бажаного.',
        },
