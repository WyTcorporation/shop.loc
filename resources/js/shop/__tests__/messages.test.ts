...
const keys: Array<{ key: TranslationKey; params?: Record<string, any> }> = [
    ...
    { key: 'sellerPage.pageTitle', params: { name: 'Vendor' } },
    { key: 'sellerPage.documentTitle', params: { name: 'Vendor', brand: 'Shop' } },
    { key: 'sellerPage.productsTitle' },
    { key: 'sellerPage.loadingVendor' },
    { key: 'sellerPage.notFound' },
    { key: 'sellerPage.noProducts' },
    { key: 'sellerPage.noImage' },
    { key: 'sellerPage.contact.email', params: { email: 'seller@example.com' } },
    { key: 'sellerPage.contact.phone', params: { phone: '+123456' } },
    { key: 'sellerPage.seo.title', params: { name: 'Vendor', brand: 'Shop' } },
    {
        key: 'sellerPage.seo.description',
        params: { description: 'Great seller', email: 'seller@example.com', phone: '+123456' },
    },
    { key: 'sellerPage.pagination.prev' },
    { key: 'sellerPage.pagination.next' },
    { key: 'sellerPage.pagination.status', params: { page: 2, lastPage: 5 } },
    { key: 'sellerPage.errors.loadProducts' },
    { key: 'sellerPage.ga.listName', params: { name: 'Vendor' } },
    ...
    { key: 'order.confirmation.chat.unreadBadge', params: { count: 2 } },
    ...
    { key: 'wishlist.empty' },
    { key: 'wishlist.button.add' },
    { key: 'wishlist.button.remove' },
    { key: 'wishlist.button.addAria' },
    { key: 'wishlist.button.removeAria' },
    ...
    { key: 'product.similar.title' },
    { key: 'product.similar.empty' },
    { key: 'product.similar.noImage' },
    ...
    { key: 'profile.orders.table.headers.messages' },
    { key: 'profile.orders.table.headers.total' },
    { key: 'profile.orders.table.headers.actions' },
    { key: 'profile.orders.table.view' },
    { key: 'profile.orders.table.unreadBadge', params: { count: 3 } },
    { key: 'profile.orders.table.noUnread' },
    // Profile addresses
